// cloud Moodboard - Simple interactions

document.addEventListener("DOMContentLoaded", () => {
  const iscloud = document.body.classList.contains("cloud-page");
  const scrollContainer = document.getElementById("cloud-scroll");

  if (iscloud && scrollContainer) {
