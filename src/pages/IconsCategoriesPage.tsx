...
export const IconsCategoriesPage: React.FC = () => {
  return (
    <SimpleIconsPage
      title="Icons – Categories"
      description="Preview of your icon categories page from the demo."
    />
  );
};
...
const SimpleIconsPage: React.FC<SimpleIconsProps> = ({
  title,
  description
}) => (
    ...
    <div className="mx-auto flex max-w-4xl flex-col gap-8 px-4 py-8 md:px-8">
      ...
      <section className="rounded-3xl border border-white/15 bg-zinc-900/70 p-6 text-sm text-zinc-200 shadow-md shadow-black/60">
        <p>
          ...
          stub that keeps routing and basic styling in place.
        </p>
      </section>
    </div>
  </div>
